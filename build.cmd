...
jpackage --input . --name jtreesize --main-jar lib/jtreesize-%PKG_VERSION%.jar --main-class org.ligson.jtreesize.JTreeSizeBoot --type exe --resource-dir conf --icon conf/treesize.ico --win-dir-chooser --win-shortcut --app-version %PKG_VERSION%
